...
def show_score(choice, color, font, size):
    ...
    score_surface = score_font.render('Score : ' + str(score), True, color) # create the display surface object
    score_rect = score_surface.get_rect() # create a rectangular object for the text surface object
